    ...
    <>
      {loading ? (
        ...
        <div
          className={`${
            oAuth ? "hidden" : ""
          } w-full h-[100dvh] flex flex-col items-end justify-center `}
        >
          <Image
            src="/BgWelcomePage.png"
            alt="bg"
            fill
          ...
          <div className="w-full h-fit p-5 flex flex-col justify-center items-center gap-4 z-30 absolute bottom-0">
            <h1 className="text-4xl font-bold text-white text-center">
              Welcome to <br /> Anime Astral 👋
            </h1>
            <p className="text-sm text-white text-center w-[85%]">
            ...
            <button
              ...
              className="w-full rounded-full text-sm bg-[#05c149] shadow-md shadow-[#05c149]/50 text-white py-4 hover:cursor-pointer"
            >
              Get Started
            </button>
          </div>
        ...
        <div className="w-full h-[100dvh] flex justify-center items-center p-5">
          ...
          <div className="w-full h-full flex-col flex items-center justify-center">
            ...
            <Link href="/login" className="w-full mt-5">
              <button className="w-full rounded-full text-sm bg-[#05c149]   text-white py-4 hover:cursor-pointer">

  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="flex flex-row gap-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="none" stroke="#E0E0E0" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 5v14.586c0 .89 1.077 1.337 1.707.707L12 14l6.293 6.293c.63.63 1.707.184 1.707-.707V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2Z"/></svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="#E0E0E0" d="m21.707 11.293l-8-8A1 1 0 0 0 12 4v3.545A11.015 11.015 0 0 0 2 18.5V20a1 1 0 0 0 1.784.62a11.456 11.456 0 0 1 7.887-4.049c.05-.006.175-.016.329-.026V20a1 1 0 0 0 1.707.707l8-8a1 1 0 0 0 0-1.414ZM14 17.586V15.5a1 1 0 0 0-1-1c-.255 0-1.296.05-1.562.085a14.005 14.005 0 0 0-7.386 2.948A9.013 9.013 0 0 1 13 9.5a1 1 0 0 0 1-1V6.414L19.586 12Z"/></svg>
      </div>  
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><defs><linearGradient id="halfFill" x1="0" x2="1" y1="0" y2="0"><stop offset="50%" stopColor="#05C149" /><stop offset="50%" stopColor="rgba(5,193,73,0.25)" /></linearGradient></defs><path fill="url(#halfFill)"d="M12 3L9.65 8.76L3.44 9.22L8.2 13.24L6.71 19.28L12 16L17.29 19.28L15.8 13.24L20.56 9.22L14.35 8.76L12 3Z"/></svg>
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24"><path fill="#05c149" d="M9.29 15.88L13.17 12L9.29 8.12a.996.996 0 1 1 1.41-1.41l4.59 4.59c.39.39.39 1.02 0 1.41L10.7 17.3a.996.996 0 0 1-1.41 0c-.38-.39-.39-1.03 0-1.42z"/></svg>
      </div>
       ...
       <p className="p-2 border border-[#05c149] text-[#05c149] text-xs rounded-md px-3">Subtitle</p>
        ...
        <p className="text-[#E0E0E0] text-[14px] font-normal">
         <span className="font-medium">Genre:</span>  {anime.genres?.map((g) => g.name).join(", ")}
          {anime.genres && anime.genres.length > 5 && ", ..."}
        </p>
        <p className="text-[#E0E0E0]">
            {anime.synopsis??"".length > 100 ? `${anime.synopsis?.slice(0, 170)} ...` : title}
        </p>
        </div>
